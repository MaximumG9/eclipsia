...
class CID {
    companion object {
        ...
        const val TRIDENT = "inventory-trident"
        const val FAKE_SPECIAL_ITEM = "inventory-fake-special-item"
        ...
        const val ABILITY_SELECT_PLAYER_CANCEL ="ability-select-player-confirm"

        const val ROLE_SELECT_ADD_ROLE = "role-select-add-role"
        const val MODIFIER_SELECT_ADD_MODIFIER = "modifier-select-add-modifier"
    }
}